...
function Navbar() {
    ...
    const imgSource =
        "https://drive.google.com/uc?id=1pNOF57BJLqzmf5lXDBhKuzzv0qGh8Pi_";
    ...
    return (
        <header className="bg-gray-200 fixed w-full shadow-xl z-50">
            <div className="flex items-center justify-between max-w-7xl mx-auto p-4 md:p-8">
                ...
                <nav
                    className={`${nav ? "block" : "hidden"
                        } md:flex md:items-center w-full md:w-auto transition-all duration-500 ease-out`}
                >
